...
import { User, LayoutDashboard, Settings, LogOut, Heart, Menu } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 flex h-16 items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {user ? (
            ...
            <>
              <Link to="/?signin=true" className="hidden sm:block">
                <Button>Sign in with Google</Button>
              </Link>
              <Link to="/?signin=true" className="sm:hidden">
