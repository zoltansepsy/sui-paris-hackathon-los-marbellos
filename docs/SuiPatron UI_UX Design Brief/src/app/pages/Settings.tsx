            ...
            <CardContent className="space-y-4">
              {user.suinsName ? (
                <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">Your SuiNS name</p>
                ...
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    You haven't claimed your SuiNS name yet. Get a human-readable identity
                    like <span className="font-mono">yourname@suipatron.sui</span>
                  </p>
