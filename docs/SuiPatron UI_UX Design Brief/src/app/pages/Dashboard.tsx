...
export function Dashboard() {
  ...
  const [price, setPrice] = useState(user?.creatorProfile?.price?.toString() || '5');
          ...
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-3 gap-4">
              <div className="text-center space-y-2 p-4 bg-muted/50 rounded-lg">
                ...
                <p className="text-xs text-muted-foreground">Zero platform fees</p>
              </div>
              <div className="text-center space-y-2 p-4 bg-muted/50 rounded-lg">
                <CheckCircle2 className="h-8 w-8 mx-auto text-indigo-600" />
                <p className="font-semibold">You Own It</p>
                <p className="text-xs text-muted-foreground">Content can't be removed</p>
              </div>
              <div className="text-center space-y-2 p-4 bg-muted/50 rounded-lg">
                <Users className="h-8 w-8 mx-auto text-purple-600" />
                <p className="font-semibold">Direct Access</p>
                <p className="text-xs text-muted-foreground">One-time support model</p>
              </div>
            </div>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <Button variant="outline" className="w-full">PDF</Button>
              </div>
            </div>
            <div className="space-y-2">
      ...
      <Dialog open={showSuiNSModal} onOpenChange={setShowSuiNSModal}>
        <DialogContent>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Input
                  id="suins"
                  value={suinsInput}
                  onChange={(e) => setSuinsInput(e.target.value.toLowerCase().replace(/[^a-z0-9]/g, ''))}
          ...
          <DialogFooter>
            ...
            <Button onClick={handleClaimSuiNS} disabled={!suinsInput.trim() || isSaving}>
              {isSaving ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Claiming...
